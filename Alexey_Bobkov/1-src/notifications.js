function notifications(window) {
    ...
    var pushImgElement = document.querySelector('.push_image');
    ...
    function changePushStatus(status) {
        ...
        if (status) {
            ...
            pushImgElement.src = './1-src/components/PushToggle/push-on.png';
        }
        else {
            pushElement.classList.remove('active');
            pushImgElement.src = './1-src/components/PushToggle/push-off.png';
        }
    }
